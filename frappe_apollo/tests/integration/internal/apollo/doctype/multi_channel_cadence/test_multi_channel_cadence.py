...
from frappe_apollo.apollo.doctype.multi_channel_cadence.multi_channel_cadence import add_people_to_sequence
from frappe_apollo.apollo.doctype.people.people import _create_people
from frappe_apollo.apollo.doctype.sequence.sequence import _assign_people_to_sequence
...
class TestMCCIntegration(IntegrationTestCase):
    ...
    def test_sequence_inactive_raises_wait(self, mock_get_all, mock_get_doc, mock_get_value, mock_wait):
        ...
        with self.assertRaises(SuspendJob):
            _assign_people_to_sequence("mcc1")
    ...
    def test_valid_sync(self, mock_client_class, mock_get_all, mock_get_doc, mock_get_value, mock_wait):
        ...
        mock_mailbox = MagicMock()
        mock_mailbox.account = "acc1"
        mock_mailbox.apollo_id = "mb_apollo_1"
        ...
        mock_client.add_people_to_sequence.assert_called_once_with("pid1", "seq1", "mb_apollo_1")
